...
public class LoggerAspect {
    ...
    @Around("execution(* com.hh.multiboardadmin.domain..*Controller.*(..)) || execution(* com.hh.multiboardadmin.domain..*Service.*(..)) || execution(* com.hh.multiboardadmin.domain..*Mapper.*(..))")
